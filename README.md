<h2>Hi, I'm Steve. Welcome to my Github profile </h2>



I am a developer, working full-time at Teamwork.com. I mostly work on frontend features around reporting, people, and client focused areas but I've worked on a range of other features across the platform and migrated a host of features from older to newer codebase. I really enjoy learning, training, creating solutions, and pairing up with others to work on something new. 

Most of my public repos are just temporary projects for learning or testing things out, if you want to see what I've been working on the past few years, head over to [Teamwork.com](https://www.teamwork.com/product/reporting/) and check out the custom reporting, Teamwork.com reports, formula fields, scheduled reporting, and the clients area of the platform. 
